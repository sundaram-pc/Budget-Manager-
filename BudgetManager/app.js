var budgetController = (function() {
    ...
    Expense.prototype.calcPercentage=function(totalIncome,budget){
        console.log(budget)    ;
        if(totalIncome>0 && budget>0)
    ...
    return {
        ...
        if(data.total.inc > data.total.exp)
        ...
        calculatePercentage: function() {
            ...
            data.allItems.exp.forEach(function(cur) {
                ...
                cur.calcPercentage(data.total.inc,data.budget);                          
            });
        },
